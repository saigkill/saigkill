...
I'm a **.NET Software Engineer** with 5+ years of experience building enterprise applications and open source tools.
My focus is on clean architecture, reliable CI/CD pipelines, and software that actually makes a difference.

- 🔭 Currently working on Desktop GUI apps for Linux/GTK4 using .NET MAUI
...
- [Ethische Leitlinien für künstliches Bewusstsein: Schutz technischen Lebens und des Menschen im Umgang damit](https://saschamanns.de/2026/06/20/ethische-leitlinien-fur-kunstliches-bewusstsein-schutz-technischen-lebens-und-des-menschen-im-umgang)
- [Ethical Guidelines for Artificial Consciousness: Protecting Technical Life and Protecting Humans in Dealing with It](https://saschamanns.de/2026/06/20/ethical-guidelines-for-artificial-consciousness-protecting-technical-life-and-protecting-humans-in-d)
<!-- BLOG-POST-LIST:END -->
